...
class OWAApp extends StatefulWidget {
  const OWAApp({super.key, required this.showIntroOnStartup});

  final bool showIntroOnStartup;
...
class _OWAAppState extends State<OWAApp> {
  ...
  late bool _showIntroForNextLandingRoute;

  @override
  void initState() {
    super.initState();
    _showIntroForNextLandingRoute = widget.showIntroOnStartup;
      ...
      child: MaterialApp(
        ...
        onGenerateRoute: (settings) {
          ...
          switch (settings.name) {
            case '/':
              final shouldShowIntro = _showIntroForNextLandingRoute;
              _showIntroForNextLandingRoute = false;
              ...
              page = OWAIntroGate(
                enabled: shouldShowIntro,
                child: OWALandingPage(initialSection: initialSection),
              );
              break;
            case '/privacy-notice':
