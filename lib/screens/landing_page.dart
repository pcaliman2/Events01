...
import 'package:owa_flutter/widgets/mobile_footer_reveal_overlay.dart';
...
class _OWALandingPageState extends State<OWALandingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final double footerHeight =
        isDesktop
            ...
            : (_mobileFooterHeight > 0
                ? _mobileFooterHeight
                : MediaQuery.sizeOf(context).height * 1.35);
    final desktopFooterWidget = OWAFooter(key: _footerKey);
        ...
        builder: (context, controller, scrollPhysics, usesSmoothScroll) {
          return Stack(
            children: [
              ...
              if (isDesktop)
                Positioned(
                  ...
                  child: AnimatedBuilder(
                    ...
                    child: RepaintBoundary(child: desktopFooterWidget),
                    builder: (context, child) {
                      ...
                      return Listener(
                        ...
                        onPointerSignal:
                            OWASmoothScroll.isDesktopWebPlatform()
                                ? null
                                : _forwardFooterWheel,
                        child: ClipRect(
                          child: Align(
              ...
              if (!isDesktop)
                OWAMobileFooterRevealOverlay(
                  controller: _scrollController,
                  footerKey: _footerMobileKey,
  ...
  void _forwardFooterWheel(PointerSignalEvent event) {
    ...
    final target =
        (position.pixels + event.scrollDelta.dy)
